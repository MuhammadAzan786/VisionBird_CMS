...
const EmployeeNewProfile = () => {
  ...
  const profile = currentUser.employeeProImage;
  const profilePic = currentUser.employeeProImage
  ...
  return (
    <Box p={3}>
      <Box display={"flex"} alignItems={"center"} gap={4}>
        <Avatar sx={{ height: 150, width: 150 }} src={profilePic}>
        ...
        >
          <Box>
            <Header title={currentUser.employeeName} />
