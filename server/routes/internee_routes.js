...
router.get(
  ...
  auth,
  authorizeRoles("admin", "manager"),
  interneeController.Get_All_internees
);
router.get(
  "/get_internee/:id",
  auth,
  authorizeRoles("admin", "manager"),
  interneeController.Get_internee
);
router.delete(
  "/delete_internee/:id",
  authorizeRoles("admin", "manager"),
  auth,
  interneeController.Delete_internee
);

router.get(
  "/get_active_internees",
  auth,
  authorizeRoles("admin", "manager"),
  interneeController.active_internees
);

router.get(
  "/get_inactive_internees",
  auth,
  authorizeRoles("admin", "manager"),
  interneeController.inactive_internees
);
