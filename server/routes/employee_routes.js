...
router.patch(
  "/update_employee/:id",auth, authorizeRoles('admin','manager','employee'),
  upload.fields([
    { name: "cnicScanCopy", maxCount: 1 },
    { name: "policeCertificateUpload", maxCount: 1 },
    { name: "degreesScanCopy", maxCount: 1 },
...
router.get("/get_managers_employees",auth, authorizeRoles('admin','manager'),Employee_controller.get_managers_employees);
